...
class Quiz {
    ...
    processAnswer() {
        let checkedRadio = document.querySelector(
            `input[name="${this.radioName}"]:checked`);
    ...
    presentGameOverStats(){
        ...
        this.container.insertAdjacentHTML("beforeend", `<p>Thank you for taking
         the time to play this trivia game. You answered <b>
         ${this.correctAnswers}</b> questions correctly out of <b>
         ${this.quizQuestions.length}</b>. </p>
         <p> <a href="/index.html">Go back to the main page?</a>`);
    }
};
...
window.onload = () => {
    ...
    const Q = new Quiz([q1, q2, q3, q4, q5], "trivia-display", "trivia-feedback");
    Q.presentNextQuestion();
